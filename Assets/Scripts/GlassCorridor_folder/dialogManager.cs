...
public class dialogManager : MonoBehaviour
{
    ...
    [SerializeField]  public Animator boxAnim;
    ...
    public void TextDialog(string text, string name, Sprite image)
    {
    ...
    public void NextIndex()
    {
        ...
        if (TextOut.text == "Ёэээ, это реально странно, ну ладно. ”видимс€ в столовке.")
        {
            EndDialog();
        }
    }
